        ...
        <>
          <Layout title="Popietarios">
            <div className="w-full pb-12 h-full  fixed bg-tenis-desktop bg-cover bg-[30%]">
              <div className="flex flex-col overflow-scroll pb-12 gap-16 mx-1 h-full pt-24 relative lg:flex-row lg:mx-20 lg:pt-0 lg:items-center lg:bottom-20 lg:justify-between">
                {' '}
